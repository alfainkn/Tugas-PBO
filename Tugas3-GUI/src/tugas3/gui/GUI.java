       ...
       public void actionPerformed(ActionEvent e){
           ...
           if(e.getSource() == bhitung){
               if(fpanjang.getText().isEmpty()){
                    JOptionPane.showMessageDialog(this, "'Panjang' masih kosong.");
               } else if(flebar.getText().isEmpty()){
                    JOptionPane.showMessageDialog(this, "'Lebar' masih kosong.");
               } else if(ftinggi.getText().isEmpty()){
                    JOptionPane.showMessageDialog(this, "'Tinggi' masih kosong.");
               } else {
                    try{
